...
# Messaging-platform catalog (metadata, env-var specs, builder) lives in the
# import-safe gateway.platform_catalog module so the aiohttp api_server can
# reuse it without dragging in FastAPI. Re-exported here for in-module callers.
from gateway.platform_catalog import (
    _PLATFORM_OVERRIDES,
    _PLATFORM_ORDER,
    _MESSAGING_KEYS_PAGE_KEYS,
    _platform_env_prefixes,
    _discover_platform_env_vars,
    _merge_platform_env_vars,
